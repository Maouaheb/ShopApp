...
public class Subscribe extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		listView.getItems().add("Disability");
		...
		Label indiceL = new Label("Severity");
		indiceL.setId("labelProduct");
		indice.setId("labelProduct");
		// incrementer
		...
		listView.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent arg0) {
				// TODO Auto-generated method stub
				if (listView.getValue() == "Disability") {
					presbytie = new CheckBox("presbytie");
					presbytie.setId("checkbox");
					colorblind = new CheckBox("colorblind");
					colorblind.setId("checkbox");
					gridPane.add(presbytie, 3, 3);
					gridPane.add(colorblind, 4, 3);
					gridPane.add(indiceL, 7, 3);
					gridPane.add(plus, 8, 3);
					gridPane.add(indice, 9, 3);
					gridPane.add(moins, 10, 3);
				}
		...
		Text text = new Text("Create your account");
		text.setId("text");
		// Adding text to HBox
		...
		btnLogin.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent arg0) {
				...
				if (handicap == "Disability") {
					double indice = count;
					h = 1;
					if (presbytie.isSelected()) {
						p = 1;
					}
				...
				c.addUser(name, pwd, h, p, cc, lblMessage, count, date);
